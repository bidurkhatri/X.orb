/**
 * @file index.ts
 * @description Shared type definitions for the Xorb monorepo.
 *
 * These types are the single source of truth used across:
 * - xorb-blockchain-os (Vite React web app)
 * - xorb-mobile (Expo React Native)
 * - smart-contracts (Hardhat)
 *
 * When updating types here, both web and mobile packages should be
 * migrated to import from "@xorb/shared-types" instead of maintaining

...
describe("SylOS Economy Contracts", function () {
    ...
    beforeEach(async function () {
        ...
        // Deploy a simple ERC20 for testing (mock wSYLOS)
        const MockToken = await ethers.getContractFactory("SylOSToken");
    ...
    describe("PaymentStreaming", function () {
        const ratePerSecond = ethers.parseEther("0.01"); // 0.01 wSYLOS/sec
    ...
    describe("AgentMarketplace", function () {
        const hourlyPrice = ethers.parseEther("5"); // 5 wSYLOS/hour

...
/**
 * @title AgentRegistry
 * @dev On-chain agent lifecycle management for SylOS civilization.
 *
 * Agents are licensed workers in a regulated digital civilization.
 * They must be spawned by a human sponsor, post a wSYLOS stake bond,
...
contract AgentRegistry is AccessControl, ReentrancyGuard, Pausable {
    ...
    struct AgentRecord {
        ...
        string name;
        AgentRole role;
        uint256 stakeBond;          // wSYLOS staked as collateral
    ...
    IERC20 public immutable stakeToken;         // wSYLOS token
    ...
    uint256 public minStakeBond = 100 * 10**18;  // 100 wSYLOS minimum
    ...
    /**
     * @notice Spawn a new agent. Requires wSYLOS stake bond.
     * @param _name Human-readable agent name
     * @param _role Agent's licensed profession
     * @param _stakeBond Amount of wSYLOS to stake as collateral
     ...
     * @param _amount Amount of wSYLOS to slash

 ...
 * @dev Marketplace for hiring and renting AI agents in SylOS civilization.
 *
 ...
 *
 * This is the labor market of the SylOS civilization.
 */
contract AgentMarketplace is AccessControl, ReentrancyGuard, Pausable {
    ...
    struct Listing {
        ...
        bytes32 agentId;
        uint256 pricePerUnit;     // wSYLOS per hour/day/task

 ...
 * @dev Continuous micropayment streams for agent services in SylOS.
 *
 * In the SylOS civilization, agents earn money for work. Rather than
 * lump-sum payments, sponsors stream wSYLOS to agents over time:
 *
...
contract PaymentStreaming is AccessControl, ReentrancyGuard, Pausable {
    ...
    IERC20 public immutable paymentToken; // wSYLOS
    ...
    struct Stream {
        ...
        uint256 ratePerSecond;    // wSYLOS per second (in wei)

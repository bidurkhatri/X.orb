...
describe("Xorb Agent Network", function () {
  ...
  const STAKE_AMOUNT = ethers.parseEther("200"); // 200 USDC
  ...
  beforeEach(async function () {
    ...
    sylToken = await XorbToken.deploy(
      "Xorb Token",
      "XORB",
      INITIAL_SUPPLY,
    ...
    wrappedSylos = await WrappedXORB.deploy(
    ...
    // First, transfer XORB to sponsors
    ...
    // Sponsors wrap their XORB to USDC
    ...
    // Approve AgentRegistry to spend USDC for staking

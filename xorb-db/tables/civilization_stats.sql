-- Network Stats: Aggregated metrics for the dashboard
...
INSERT INTO network_stats (id) VALUES ('global') ON CONFLICT DO NOTHING;

ALTER TABLE network_stats ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Public can view stats" ON network_stats
    FOR SELECT USING (true);

CREATE POLICY "Service role can update" ON network_stats

...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for nft-assets" ON storage.objects FOR SELECT USING (bucket_id = 'nft-assets');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for nft-assets" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'nft-assets');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for nft-assets" ON storage.objects FOR UPDATE USING (bucket_id = 'nft-assets');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for nft-assets" ON storage.objects FOR DELETE USING (bucket_id = 'nft-assets');`
    ];

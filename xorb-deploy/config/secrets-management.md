# Xorb Secrets Management Configuration
...
DATABASE_URL=postgresql://dev:dev@localhost:5432/xorb_dev
...
DATABASE_URL=postgresql://stage:stage@staging-db:5432/xorb_staging
...
DATABASE_URL=postgresql://prod:secure@prod-cluster:5432/xorb_production
